...
- Focus your assignment on one or more of the "Test Case Types" for each week.   
...
- With the "No code tools," you can program anything that you can imagine.  
- Here is a screen shot of a game that I created live in class (took less than an hour).  This illustrates interactive black box testing techniques, in this case, Equivalence Classes/Boundary Values. 
- Can you think of a more creative way to illustrate the techniques?
- Can ChatGPT think of any good ideas?  
- Get creative. 
...
- These assignments are due on weeks 3, 5, and 7.  


| WEEK DUE | TOPIC |
|----------|-------|
| 3 | Equivalence Classes/Boundary Values (do both) |
| 5 | Decision Tables/Pairwise Testing (choose one or both) |
| 7 | State Transitions/ Control Flow Testing/ Data Flow Testing (choose one or all 3) |
