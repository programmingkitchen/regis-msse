...
public class FlightReservationManager extends ManagerSuperType {
	...
	/**
	 * A reservation consists of a traveler and a flight along with some other info.  We get the 
	 * information about the traveler and the flight and then store it in the composite which 
	 * gets passed in to the lower layers. 
	 * 
	 * @param args
	 */
