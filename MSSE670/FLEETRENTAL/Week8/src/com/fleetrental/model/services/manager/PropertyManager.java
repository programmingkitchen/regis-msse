...
public class PropertyManager
{
	...
	public static void loadProperties(String propertyFileLocation) throws PropertyFileNotFoundException
	{
	    ...
	    try
	    {
		 ...
		 {
	    	System.out.println("Property file not found at location" + propertyFileLocation);
	    	throw new PropertyFileNotFoundException ("Property File cannot be found.", fnfe);
		 }
	    catch (IOException ioe) 
	    {
	    	System.out.println("IOException while loading property file from location: " + propertyFileLocation);
	    	throw new PropertyFileNotFoundException ("IOException while loading Properties file.", ioe);	    	
	    }
	    catch (Exception excp) 
	    {
	    	System.out.println("Exception while loading property file from location: " + propertyFileLocation);
	    	throw new PropertyFileNotFoundException ("Exception while loading Properties file:" + propertyFileLocation, excp);	    	
	    }
		finally
		{
			if (sf != null)
